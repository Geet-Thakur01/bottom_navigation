...
public class DashBoardFragment extends Fragment implements DashboardView {
    ...
    private DashBoardPresenterInterface dashBoardPresenterInterface;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        dashBoardPresenterInterface = new DashBoardPresenter(this);
        dashBoardPresenterInterface.updateInfo();
        return view;
    }
    ...
    @Override
    public void onUpdateInfo(String profilepicUrl, String basicinfo) {
        Picasso.with(getActivity()).load(profilepicUrl).into(profile_pic);
        profile_info.setText(basicinfo);
    }
